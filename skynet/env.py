...
whisper_recorder_model_name = os.environ.get('WHISPER_RECORDER_MODEL_NAME')
...
whisper_recorder_transcribe_after_seconds = int(os.environ.get('WHISPER_RECORDER_TRANSCRIBE_AFTER_SECONDS', 3))
