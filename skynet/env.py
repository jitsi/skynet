...
whisper_recorder_model_name = os.environ.get('WHISPER_RECORDER_MODEL_NAME', None)
whisper_recorder_model_path = os.environ.get('WHISPER_RECORDER_MODEL_PATH', '/models/faster-whisper-large-v3-turbo-ct2')
whisper_recorder_quantization = os.environ.get('WHISPER_RECORDER_QUANTIZATION', 'int8')
whisper_recorder_transcribe_after_seconds = int(os.environ.get('WHISPER_RECORDER_TRANSCRIBE_AFTER_SECONDS', 2))
whisper_recorder_audio_path = os.environ.get('WHISPER_RECORDER_AUDIO_PATH', '/tmp/audio_queue')
whisper_recorder_num_processes = int(os.environ.get('WHISPER_RECORDER_NUM_PROCESSES', 1))
